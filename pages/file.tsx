        ...
        component={
            <Grid container direction="column" wrap="nowrap">
                <Grid
                    ...
                    style={
                        {
                            background: "url('/file-banner.png') no-repeat",
                ...
                >
                    <Grid item container direction="column" wrap="nowrap" xs={12} md={6} lg={5} className="p-2 p-lg-5">
                        ...
                        <Typography color="white" className="p-2" fontSize="medium">
                ...
                <Grid
                    ...
                    style={
                        {
                            background: "url('/file-bottom-banner.png') no-repeat",
                            backgroundPosition: "center center",
                            backgroundSize: "cover"
                        }
                    }
