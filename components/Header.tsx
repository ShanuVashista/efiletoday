import {Button, Drawer, Grid, Hidden, IconButton, Typography} from "@mui/material";
...
const Header = () => {
    ...
    const content = <>{
        links.map((link, i) => <Grid key={i} className="p-2 p-md-2">
        ...
        >
            ...
            <Grid container direction="column" wrap="nowrap" item xs>
                ...
                <Grid container alignItems="center" wrap="nowrap" justifyContent={"space-between"}>
                    ...
                    <Grid item md={2} className="p-3 p-lg-0">
                        <Button
                            variant="contained"
                            size="small"
                    ...
                    <Hidden mdUp>
                        <Grid item md={2} className="p-2 p-lg-0">
                            <IconButton
